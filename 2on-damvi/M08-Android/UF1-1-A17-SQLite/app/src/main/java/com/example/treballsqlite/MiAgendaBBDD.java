...
public class MiAgendaBBDD extends SQLiteOpenHelper {
	...
	// En este caso la BBDD solo tiene una tabla, asi que solo creamos un sql de creacionç+
	// Si hubiese mas tablas, tendrianmos que crear todas las tablas y relaciones aquí,
